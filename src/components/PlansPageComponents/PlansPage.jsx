    ...
    return (
        ...
        <body className="absolute top-0 left-0 w-full bg-color">
            ...
            <main className="w-full mt-20 md:my-28 md:mb-80 px-6 md:px-12">
                ...
                <div className="dark-backdrop-box fixed flex flex-col md:flex-row md:absolute top-20 pb-24 px-6 md:top-1/3 lg:top-1/2 left-0 w-full h-1/2 md:h-2/3 md:pt-24 md:px-12 shadow-lg">
